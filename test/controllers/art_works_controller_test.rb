...
class ArtWorksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art_work" do
    assert_difference('ArtWork.count') do
      post art_works_url, params: { art_work: { artist: @art_work.artist, date_painted: @art_work.date_painted, location: @art_work.location, title: @art_work.title } }
    end
  ...
  test "should update art_work" do
    patch art_work_url(@art_work), params: { art_work: { artist: @art_work.artist, date_painted: @art_work.date_painted, location: @art_work.location, title: @art_work.title } }
